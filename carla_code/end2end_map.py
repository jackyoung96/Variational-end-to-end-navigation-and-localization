...
rospy.init_node("CoaseGrainMap")
pub = rospy.Publisher('/coarsemap', Image, queue_size=10)
br = CvBridge()
...
class MapImage(object):
    ...
    def __init__(self, carla_world, carla_map, pixels_per_meter, show_triggers, show_connections, show_spawn_points):
        ...
        full_path2 = str(os.path.join("/home/jackyoung96", filename))
        ...
        if os.path.isfile(full_path):
            ...
            # pygame.image.save(self.big_map_surface, full_path2)
...
class World(object):
    ...
    def render(self, display):
        ...
        if self.hero_actor is not None:
            ...
            rotated_result_surface = pygame.transform.rotozoom(self.hero_surface, angle, 0.5).convert()
            ...
            # bias = 4655
            pub.publish(br.cv2_to_imgmsg(pygame.surfarray.array3d(rotated_result_surface).swapaxes(0,1),'bgr8'))
            ## modify ###
            ...
            if abs(self.xyz[0]-location.x) + abs(self.xyz[1]-location.y) > 10 and self.count < 800:
                self.xyz[0] = location.x
                self.xyz[1] = location.y
                # pygame.image.save(rotated_result_surface, 
                # "/home/jackyoung96/DRL_toy/end2end/{}.png".format(self.count+bias))
